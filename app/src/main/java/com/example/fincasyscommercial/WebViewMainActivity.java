...
import com.example.fincasyscommercial.networkmanager.DroidListener;
...
public class WebViewMainActivity extends AppCompatActivity implements DroidListener {

    public static final int INPUT_FILE_REQUEST_CODE = 1;
    private static final int RC_SIGN_IN = 101;
    private static final String MAIN_URL = "https://sp.fincasys.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDroidNet.addInternetConnectivityListener(WebViewMainActivity.this);
        ...
        if (isCheckPermission(WebViewMainActivity.this)) {
        ...
        txtno_internet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    AlertDialog alertDialog = new AlertDialog.Builder(WebViewMainActivity.this).create();
    ...
    /*  public boolean isCameraPermissonGranted(Context ctx) {
          if (Build.VERSION.SDK_INT >= 23) {
              if (ctx.checkSelfPermission(Manifest.permission.CAMERA)
                  ...
                  isReadStoragePermissionGranted(WebViewMainActivity.this);
                  return true;
