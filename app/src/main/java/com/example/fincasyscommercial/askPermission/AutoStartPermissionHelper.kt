package com.fincasys.fincasysapp.askPermission
...
class AutoStartPermissionHelper private constructor() {
    ...
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_B = "com.coloros.safecenter.permission.startup.FakeActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_C = "com.coloros.safecenter.permission.startupapp.StartupAppListActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_D = "com.coloros.safecenter.permission.startupmanager.StartupAppListActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_E = "com.coloros.safe.permission.startup.StartupAppListActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_F = "com.coloros.safe.permission.startupapp.StartupAppListActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_G = "com.coloros.safe.permission.startupmanager.StartupAppListActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_H = "com.coloros.safecenter.permission.startsettings"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_I = "com.coloros.safecenter.permission.startupapp.startupmanager"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_J = "com.coloros.safecenter.permission.startupmanager.startupActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_K = "com.coloros.safecenter.permission.startup.startupapp.startupmanager"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_L = "com.coloros.privacypermissionsentry.PermissionTopActivity.Startupmanager"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_M = "com.coloros.privacypermissionsentry.PermissionTopActivity"
    private val PACKAGE_OPPO_COMPONENT_FALLBACK_N = "com.coloros.safecenter.FakeActivity"
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        exx.printStackTrace()
                        try {
                            startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_B)
                        } catch (exxx: Exception) {
                            exxx.printStackTrace()
                            try {
                                startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_C)
                            } catch (exxxx: Exception) {
                                exxxx.printStackTrace()
                                try {
                                    startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_D)
                                } catch (exxxxx: Exception) {
                                    exxxxx.printStackTrace()
                                    try {
                                        startIntent(context, PACKAGE_OPPO_FALLBACK, PACKAGE_OPPO_COMPONENT_FALLBACK_E)
                                    } catch (exxxxxx: Exception) {
                                        exxxxxx.printStackTrace()
                                        try {
                                            startIntent(context, PACKAGE_OPPO_FALLBACK, PACKAGE_OPPO_COMPONENT_FALLBACK_F)
                                        } catch (exxxxxxx: Exception) {
                                            exxxxxxx.printStackTrace()
                                            try {
                                                startIntent(context, PACKAGE_OPPO_FALLBACK, PACKAGE_OPPO_COMPONENT_FALLBACK_G)
                                            } catch (exxxxxx: Exception) {
                                                exxxxxx.printStackTrace()
                                                try {
                                                    startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_H)
                                                } catch (exxxxxx: Exception) {
                                                    exxxxxx.printStackTrace()
                                                    try {
                                                        startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_I)
                                                    } catch (exxxxxx: Exception) {
                                                        exxxxxx.printStackTrace()
                                                        try {
                                                            startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_J)
                                                        } catch (exxxxxx: Exception) {
                                                            exxxxxx.printStackTrace()
                                                            try {
                                                                startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_K)
                                                            } catch (exxxxxx: Exception) {
                                                                exxxxxx.printStackTrace()
                                                                try {
                                                                    startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_L)
                                                                } catch (exxxxxx: Exception) {
                                                                    exxxxxx.printStackTrace()
                                                                    try {
                                                                        startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_M)
                                                                    } catch (exxxxxx: Exception) {
                                                                        exxxxxx.printStackTrace()
                                                                        try {
                                                                            startIntent(context, PACKAGE_OPPO_MAIN, PACKAGE_OPPO_COMPONENT_FALLBACK_N)
                                                                        } catch (exxxxxx: Exception) {
                                                                            exxxxxx.printStackTrace()
                                                                            return false
                                                                        }
